...
/* Include Files */
#include "main.h"
#include "PCGMRES_fast.h"
#include "PCGMRES_fast_terminate.h"
...
double dot_phi;
  ...
  double kp_num;
  double target_tmp;
  /* Initialize function 'PCGMRES_fast' input arguments. */
  target_tmp = argInit_real_T();
  /* Call the entry-point 'PCGMRES_fast'. */
  PCGMRES_fast(target, x, y, theta, vx,
